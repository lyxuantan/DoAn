...
public class PaymentController {
    ...
    public ResponseEntity<?> createPayment(@RequestBody PaymentDTO paymentDTO) throws UnsupportedEncodingException {
        ...
        Long amount = paymentDTO.getAmountLong() * 1000;
...
//        vnp_Params.put("vnp_Command", "querydr");
        ...
        vnp_Params.put("vnp_ReturnUrl", PaymentConfig.RETURN_URL+"?amount="+amount+"&orderInfo="+paymentDTO.getIdOrder()+"&username="+paymentDTO.getUsername()+"&orderCode="+paymentDTO.getIdOrder() + vnp_CreateDate);
